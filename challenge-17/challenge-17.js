(function(){
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/g, 'Fernando Zambrano Santafé'));
    ...
    */
    ...
    console.log(text.replace(/brasileiro/g, 'venezuelano'));
