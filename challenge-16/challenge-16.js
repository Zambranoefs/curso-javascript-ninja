(function (){
    ...
    */
    ...
    var fullName = 'fernando-zambrano';
    ...
    */
    ...
    var friends = ['Daniel', 'Ana', 'Teresa', 'Gerardo', 'Maria'];
    var phrase = friends.reduce(function (cumulative, current, index){

        var separator = friends.length - 1 === index ? ' e ' : ', ';

        return cumulative + separator + current;
