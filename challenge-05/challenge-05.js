...
*/
var myArray = [33, 'Fernando', 87, 'Peixe', 'Ouvido']
...
segundo parâmetro.
*/
function secondFunction(array, index) {
    return array[index];
}
...
*/
var secondArray = [33, 'Ninja', ['stealth', 'jumping', 'speed'], true, {weapon: 'Sword'}];
...
console.log(secondFunction(secondArray, 0));
console.log(secondFunction(secondArray, 1));
console.log(secondFunction(secondArray, 2));
console.log(secondFunction(secondArray, 3));
console.log(secondFunction(secondArray, 4));
