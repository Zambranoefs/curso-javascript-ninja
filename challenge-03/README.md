...
*/
pessoa.nomeCompleto(); //"Olá! Meu nome é Fernando Zambrano"
...
retornar a string:
- "Olá, eu sou o [NOME COMPLETO], tenho [IDADE] anos, a minha altura é [ALTURA], meu peso é [PESO] e, só hoje, eu já caminhei [CAMINHOU QUANTOS METROS] metros!"
...
// Agora, apresente-se ;)
pessoa.apresentacao(); // Olá, eu sou o Fernando Zambrano, tenho 36 anos, a minha altura é 1.73, meu peso é 74 e, só hoje, eu já caminhei 600 metros!
```
